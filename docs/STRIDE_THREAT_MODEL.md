...
| MCP tool execution | Any MCP server could act as a privilege-escalation vector | **N/A, not a gap yet** | No MCP execution plane exists in this repo — nothing to escalate through until that's built |
